...
void proc1() 
{
     ...
     //printf("Proc 1 did rvm init\n");
     rvm_destroy(rvm, "testseg");
     
     segs[0] = (char *) rvm_map(rvm, "testseg", 10000);
     //printf("Proc 1 did map\n");
     //printf("Segs[0], before unmapping is %c \n", *segs[0]);
     //rvm_unmap(rvm, segs[0]);
     //printf("Segs[0], after unmapping is %c \n", *segs[0]);    
...
void proc2() 
{
     ...
     rvm = rvm_init("rvm_segments");
     printf("Proc 2 did rvm init\n");
     segs[0] = (char *) rvm_map(rvm, "testseg", 10000);
     printf("Proc 2 did map\n");
